...
//           temperature: {
//             red: 20 + Math.random() * 8 + Math.sin(i / 5) * 3,
...
//   const currentTemp =
//     historicalData.length > 0
//       ? currentTemperatures.red
//       : redTemps[redTemps.length - 1] || 0;
//   const maxTemp = Math.max(...redTemps);
//   const minTemp = Math.min(...redTemps);
//   const avgTemp =
//     redTemps.reduce((sum: number, temp: number) => sum + temp, 0) /
//     redTemps.length;
...
//             <ThermostatOutlined sx={{ fontSize: 40, color: "#f44336" }} />
...
//             <Typography variant="h6" color="#f44336" gutterBottom>
//               Current
//             </Typography>
...
//             Red Sensor Temperature History
//           </Typography>
...
//               series={[
//                 {
//                   data: redTemps.slice(-12), // Last 12 data points
//                   label: "Red Sensor (Recent)",
//                   color: "#f44336",
//                   curve: "natural",
//                 },
//               ]}
